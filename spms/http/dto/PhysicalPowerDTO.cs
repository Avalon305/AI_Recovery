...
namespace spms.http.dto
{
    public class PhysicalPowerDTO
    {
        ...
        public PhysicalPowerDTO(PhysicalPower physicalPower,Setter setter) {
            this.clientId = setter.Set_Unique_Id;
            this.fkUserId = physicalPower.FK_user_Id.ToString();
            this.gmtCreate = physicalPower.Gmt_Create.ToString();
            this.gmtModified = physicalPower.Gmt_Modified.ToString();
