...
CREATE TABLE `bdl_auth`  (
  ...
  `auth_username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限用户名',
  `auth_userpass` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  `auth_level` tinyint(1) NULL DEFAULT NULL COMMENT '角色权限级别',
  ...
  `user_status` int(3) NULL DEFAULT NULL COMMENT '使用状态',
  `auth_offlinetime` date NULL DEFAULT NULL COMMENT '离线时间',
...
CREATE TABLE `bdl_datacode`  (
  ...
  `code_xh` int(11) NULL DEFAULT NULL COMMENT '排序号，下拉列表按这个排序',
  `code_type_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型ID，dList是数据项',
  `code_s_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存储值',
  `code_c_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '展示值',
  `code_state` tinyint(4) NULL DEFAULT NULL COMMENT '是否启用 0 不启用 1启用',
  `code_e_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '英语显示值',
...
INSERT INTO `bdl_datacode` VALUES (47, NULL, 'DList', 'DEVICE', '设备类型', 1, 'Device');
INSERT INTO `bdl_datacode` VALUES (48, 1, 'DEVICE', '1', '坐式推胸机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (49, 2, 'DEVICE', '2', '腿部推蹬机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (50, 3, 'DEVICE', '3', '腹肌训练机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (51, 4, 'DEVICE', '4', '三头肌训练机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (52, 5, 'DEVICE', '5', '腿部外弯机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (53, 6, 'DEVICE', '6', '腿部内弯机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (54, 7, 'DEVICE', '7', '蝴蝶机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (55, 8, 'DEVICE', '8', '反向蝴蝶机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (56, 9, 'DEVICE', '9', '坐式背部伸展机', 1, NULL);
INSERT INTO `bdl_datacode` VALUES (57, 10, 'DEVICE', '10', '坐式划船机', 1, NULL);
...
CREATE TABLE `bdl_deviceprescription`  (
  ...
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `fk_ti_id` int(8) NULL DEFAULT NULL COMMENT '外键（bdl_trianinfo : pk_ti_id）',
  `fk_ds_id` int(8) NULL DEFAULT NULL COMMENT '外键（bdl_devicesort : pk_ds_id）',
  `device_mode` int(11) NULL DEFAULT NULL COMMENT '设备训练模式:0康复模式，1主被动模式,2被动模式',
  `dp_status` tinyint(1) NULL DEFAULT NULL COMMENT '1做了 0没做',
  `dp_moveway` int(3) NULL DEFAULT NULL COMMENT '移乘方式',
  `dp_memo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '注意点、指示',
  `speed_rank` int(11) NULL DEFAULT NULL COMMENT '运动速度等级',
  `consequent_force` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '顺向力',
  `reverse_force` double(10, 2) NULL DEFAULT NULL COMMENT '反向力',
  `dp_groupcount` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '组数',
  `dp_groupnum` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '每组个数',
  `dp_relaxtime` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '每组间隔休息时间',
...
CREATE TABLE `bdl_deviceset`  (
  ...
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `dset_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备系列名',
...
CREATE TABLE `bdl_devicesort`  (
  `pk_ds_id` int(8) NOT NULL COMMENT '设备分类id',
  `ds_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名称',
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `fk_dset_id` int(8) NULL DEFAULT NULL COMMENT '外键（bdl_deviceset : pk_dset_id）',
  `ds_status` tinyint(1) NULL DEFAULT NULL COMMENT '复选框状态是否选中',
...
INSERT INTO `bdl_devicesort` VALUES (1, '坐式推胸机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (2, '腿部推蹬机', '2018-04-19 21:47:36', '2018-04-19 21:47:38', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (3, '腹肌训练机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (4, '三头肌训练机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (5, '腿部外弯机', '2018-04-19 21:47:40', '2018-04-19 21:47:44', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (6, '腿部内弯机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (7, '蝴蝶机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (8, '反向蝴蝶机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
INSERT INTO `bdl_devicesort` VALUES (9, '坐式背部伸展机', '2019-11-01 19:37:35', '2019-11-01 19:37:35', 1, 1);
...
CREATE TABLE `bdl_nuitrack`  (
  ...
  `fk_user_id` int(11) NULL DEFAULT NULL COMMENT '用户id',
  `status` int(11) NULL DEFAULT NULL COMMENT '0删除 1存在',
...
CREATE TABLE `bdl_onlinedevice`  (
  ...
  `od_clientid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `od_clientname_en` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `od_clientname_ch` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `od_gmt_modified` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `bdl_personal_setting`  (
  ...
  `fk_member_id` int(10) NULL DEFAULT NULL COMMENT '关联bdl_user表的主键',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员卡号ID',
  `device_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
  `device_order_number` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '设备序号',
  `training_mode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练模式',
  `seat_height` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '座位高度cm',
  `backrest_distance` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '靠背距离',
  `footboard_distance` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '踏板距离',
  `lever_angle` double(10, 2) NULL DEFAULT NULL COMMENT '杠杆角度',
  `front_limit` int(10) NULL DEFAULT NULL COMMENT '前方限制',
  `back_limit` int(10) NULL DEFAULT NULL COMMENT '后方限制',
  `consequent_force` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '顺向力',
  `reverse_force` double(10, 2) NULL DEFAULT NULL COMMENT '反向力',
  `power` double(10, 2) NULL DEFAULT NULL COMMENT '功率',
  `extra_setting` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '额外属性：为保证设备属性的可扩展性，存储为Json串Key、value',
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_personal_setting个人设置' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_physicalpower`  (
  ...
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `fk_user_id` int(8) NULL DEFAULT NULL COMMENT '外键（bdl_user : pk_user_id）',
  `pp_high` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '身高',
  `pp_weight` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '体重',
  `pp_grip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '握力',
  `pp_eyeopenstand` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '睁眼单脚站立',
  `pp_functionprotract` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能性前伸',
  `pp_sitandreach` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '坐姿体前屈',
  `pp_timeupgo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'timeup go',
  `pp_walk5milegeneral` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '5m步行',
  `pp_walk5milefast` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '5m步行，最快',
  `pp_walk10mile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '10m步行，第一个字段是模式',
  `pp_walk6minute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '6分钟步行',
  `pp_step2minute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '2分钟踏步',
  `pp_legraise2minute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '2分钟抬腿',
  `pp_usermemo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '利用者感想',
  `pp_workermemo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '工作人员感想',
...
CREATE TABLE `bdl_prescriptionresult`  (
  ...
  `fk_dp_id` int(8) NULL DEFAULT NULL COMMENT '外键（dbl_deviceprescreiption : pk_dp_id）',
  `fk_ds_id` int(11) NULL DEFAULT NULL COMMENT '关联的单一设备类型ID',
  `bind_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户手环ID',
  `device_mode` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '设备训练模式:训练模式：0康复模式，1主被动模式,2被动模式',
  `consequent_force` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '顺向力',
  `reverse_force` double(10, 2) NULL DEFAULT NULL COMMENT '反向力',
  `power` double(10, 2) NULL DEFAULT NULL COMMENT '功率',
  `speed_rank` int(3) NULL DEFAULT NULL COMMENT '运动速度等级:主被动模式/被动模式 只能选运动速度',
  `finish_num` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '完成运动个数：计数模式完成个数',
  `finish_time` int(11) NULL DEFAULT NULL COMMENT '训练时间',
  `energy` double(10, 2) NULL DEFAULT NULL COMMENT '训练总耗能 单位卡路里',
  `heart_rate_list` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '心率集合：运动过程实时心率集合，数据之间*分割',
  `pr_userthoughts` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病人感想，分级选择',
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `bdl_set`  (
  ...
  `set_unique_id` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '客户机唯一id',
  `set_organizationname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '组织名称',
  `set_photolocation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '照片位置',
  `set_organizationphone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系电话',
  `set_language` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `set_organizationsort` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `set_version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `back_up` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备份路径',
...
CREATE TABLE `bdl_skeleton_length`  (
  ...
  `fk_member_id` int(11) NULL DEFAULT NULL COMMENT '关联bdl_user的主键',
  `weigth` double NULL DEFAULT NULL COMMENT '体重',
  `height` double NULL DEFAULT NULL COMMENT '身高',
  `body_length` double NULL DEFAULT NULL COMMENT '躯干长度(脖子到屁股~)',
  `shoulder_width` double NULL DEFAULT NULL COMMENT '肩宽(单侧肩宽)',
  `arm_length_up` double NULL DEFAULT NULL COMMENT '臂长(上部分)',
  `arm_length_down` double NULL DEFAULT NULL COMMENT '臂长(下部分)',
  `leg_length_up` double NULL DEFAULT NULL COMMENT '腿长(上部分)',
  `leg_length_down` double NULL DEFAULT NULL COMMENT '腿长(下部分)',
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `bdl_symptominfo`  (
  ...
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `fk_user_id` int(8) NULL DEFAULT NULL COMMENT '外键（dbl_user : pk_user_id）',
  `fk_ti_id` int(8) NULL DEFAULT NULL COMMENT '外键（dbl_traininfo : pk_ti_id）',
  `si_isjoin` tinyint(1) NULL DEFAULT NULL COMMENT '是否参加',
  `si_waterinput` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '水分摄取',
  `si_careinfo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '看护记录',
  `si_inquiry` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '问诊票',
  `si_pre_highpressure` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '高血压(康复前)',
  `si_pre_lowpressure` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '低血压(康复前)',
  `si_pre_heartrate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '心率(康复前)',
  `si_pre_pulse` int(3) NULL DEFAULT NULL COMMENT '脉(康复前)',
  `si_pre_animalheat` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '体温(康复前)',
  `si_suf_highpressure` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '高血压(康复后)',
  `si_suf_lowpressure` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '低血压(康复后)',
  `si_suf_heartrate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '心率(康复后)',
  `si_suf_pulse` int(3) NULL DEFAULT NULL COMMENT '脉(康复后)',
  `si_suf_animalheat` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '体温(康复后)',
...
CREATE TABLE `bdl_traininfo`  (
  ...
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `fk_user_id` int(8) NULL DEFAULT NULL COMMENT '外键（dbl_user : pk_user_id）',
  `status` int(1) NULL DEFAULT NULL COMMENT '0 未做 1保存 2 完成 3 废弃 4 暂存',
...
CREATE TABLE `bdl_user`  (
  ...
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病人姓名',
  `user_namepinyin` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名拼音',
  `user_sex` tinyint(1) NULL DEFAULT NULL COMMENT '性别',
  `user_birth` date NULL DEFAULT NULL COMMENT '出生日期',
  `user_groupname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '小组名称',
  `user_initcare` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '初期要介护度',
  `user_nowcare` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '现在要介护度',
  `user_illnessname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '疾病名称',
  `user_physicaldisabilities` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '残障名称',
  `user_memo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备忘',
  `user_photolocation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '照片位置',
  `user_idcard` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'id卡',
  ...
  `user_privateinfo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '非公开信息',
...
CREATE TABLE `bdl_user_relation`  (
  ...
  `fk_user_id` int(11) NULL DEFAULT NULL COMMENT '关联的用户ID',
  `bind_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '绑定的手环ID,用户绑定的蓝牙手环名称ID',
  `muscle_test_val` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '肌力测试值',
  `mtv_create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '肌力测试值创建时间',
  `gmt_create` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `gmt_modified` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 4080 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
